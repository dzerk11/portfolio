...
export const projects: Project[] = [
  {
    ...
    description:
      'A reel of gameplay experiences designed and built in Unreal Editor for Fortnite over two years of UEFN development.',
  ...
  },
  {
    ...
    description:
      'A published Fortnite island for competitive trio endgame practice — tournament-style point system, team lobbies and custom-built terrain, all scripted in Verse.',
    tags: ['UEFN', 'Verse', 'Game Design'],
  ...
  },
  {
    ...
    description:
      'Full-stack production-monitoring platform connecting industrial machinery to real-time dashboards via Kepware, ThingWorx and InfluxDB.',
